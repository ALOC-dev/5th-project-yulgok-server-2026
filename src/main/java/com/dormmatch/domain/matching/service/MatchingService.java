...
public class MatchingService {
    ...
    @Transactional
    public void confirm(Long userId, String receiverHashId){
        Long receiverId = HashIdsUtils.decode(receiverHashId);
    ...
    @Transactional
    public void heart(Long userId, String receiverHashId){
        Long receiverId = HashIdsUtils.decode(receiverHashId);
    ...
    @Transactional
    public void reject(Long userId, String receiverHashId){
        Long receiverId = HashIdsUtils.decode(receiverHashId);
